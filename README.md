...
Standalone skill for transport-relevant DFT result analysis, including batch-style candidate ranking for quick materials screening.
...
python3 scripts/compare_transport_candidates.py fixtures fixtures/candidates/heavy --occupied-bands 2 --fermi 0.35 --target-gap-min 0.5 --target-gap-max 1.0 --prefer-carrier electron-like --json
